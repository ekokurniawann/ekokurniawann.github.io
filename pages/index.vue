  ...
  <div class="landing-page">
        ...
        <div class="flex items-center pt-10 px-5 md:px-0">
          <div class="w-1/2">
            <h1 class="text-4xl text-white mb-5">
              Kami membantu <u class="hero-underline">startup</u> untuk <br />
              memulai & <u class="hero-underline">mendanai</u> <br />
              kebutuhan sejatinya
            </h1>
            <p class="text-white text-xl font-light mb-8">
              Danaikan ide terbaik untuk menjadi <br />
              produk nyata dan menjadi kontributor
            </p>
            <a
              href="#projects"
          ...
          <div class="w-1/2 flex justify-center">
            <img src="/hero-image@2x.png" alt="proyek pendanaan" />
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="flex justify-between items-center mb-10">
        <div class="w-auto">
          <h2 class="text-3xl text-gray-900 mb-8">
            Hanya 3 langkah untuk mewujudkan <br />
            ide cerah Anda
          </h2>
        </div>
      </div>
      ...
      <div class="flex justify-between items-center text-center">
        <div class="w-1/3">
          ...
          <div class="step-content">
            ...
            <p class="font-light">
              Daftarkan akun dan mulai <br />mendanai proyek
            </p>
          </div>
        </div>
        <div class="w-1/3">
        ...
        <div class="w-1/3">
          ...
          <div class="step-content">
            <h3 class="font-medium">Eksekusi</h3>
            <p class="font-light">
              Saatnya menjadikan mimpi <br />
              menjadi kenyataan
            </p>
          </div>
        </div>
    ...
    <section class="container mx-auto pt-24" id="projects">
      <div class="flex justify-between items-center">
        <div class="w-auto">
          <h2 class="text-3xl text-gray-900 mb-8">
            Proyek-proyek baru yang dapat <br />
            Anda tangani
          </h2>
        </div>
    ...
    <section class="container mx-auto pt-24" id="testimonials">
      <div class="flex justify-between items-center">
        <div class="w-auto">
          <h2 class="text-3xl text-gray-900 mb-8">
            Lihat Apa yang Dikatakan oleh <br />
            Klien Kami yang Bahagia
          </h2>
        </div>
      </div>
      <div class="flex mb-10">
        ...
        <div class="w-8/12 mt-16">
          <h2 class="text-3xl text-gray-900 font-light">
            “Mendanai di Bucker sangat mudah dan nyaman. <br />
            Hanya perlu menemukan ide, klik dan langsung mendanai.”
          </h2>
